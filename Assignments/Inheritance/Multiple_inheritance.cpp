...
public:
        ...
        terrestrial_animal()
        {
            cout<<"constructor Terrestrial Animal"<<endl;
        }
...
/*OUTPUT:
constructor Trrestrial Animal
domestic animal constructor
dog constructor
dog destructor
domestic animal destructor
destructor Terrestrial animal*/
